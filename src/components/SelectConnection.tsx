    ...
    <div className="relative z-10 inline-block">
      ...
      >
        <div>
          ...
          {!isLoading && !isLoadingVault && <span>{connection?.name || 'No integrations'}</span>}
        </div>
      ...
      <Transition
        ...
        className="min-w-sm"
      >
        <div className="absolute right-0 z-10 w-full mt-2 origin-top-right bg-white border divide-y rounded-md outline-none border-cool-gray-200 divide-cool-gray-100">
          <div className="py-1">
